...
#Add date filters or search for past records.
#Save records in CSV or Excel format.
#Allow selection of save location or filename.
#Add customer/contact details fields.
#Enable printing or exporting records.
#Provide a summary of daily/weekly sales.
#Add keyboard shortcuts for quick navigation.
#Support for multiple products per transaction.
#Add user authentication or login.
#Implement dark/light theme toggle.
#Show running balance or total sales.
#Add undo/redo functionality.
#Support for multi-language/localization.
#Visualize sales data with charts.
#Integrate with barcode scanners or printers.
#Automatically backup records.
...
def TopLevel():
    ...
    Toplevel_Options.title('WINDOW RESIZER')
    ...
    Hieght_Label = Label(Toplevel_Options, text="Hieght :")
    Hieght_Label.pack()
    Entry_hieght = StringVar()
    Hieght_Entry = Entry(Toplevel_Options, textvariable = Entry_hieght)
    Hieght_Entry.pack()
    ...
    Button = Button(Toplevel_Options, text = 'Resize!', command = resize)
    Button.pack()
