...
def Appearence_Function():
    ...
    listbox.insert(END, "yellow")
    listbox.insert(END, "orange")
    listbox.insert(END, "purple")
    listbox.insert(END, "pink")
    listbox.insert(END, "brown")
    listbox.insert(END, "black")
    listbox.insert(END, "white")
    listbox.insert(END, "gray")
    listbox.insert(END, "lightblue")
    listbox.insert(END, "lightgreen")
    listbox.insert(END, "lightyellow")
    listbox.insert(END, "lightgray")
    listbox.insert(END, "cyan")
    listbox.insert(END, "magenta")
    listbox.insert(END, "silver")
    listbox.insert(END, "gold")
    listbox.insert(END, "navy")
    listbox.insert(END, "maroon")
    listbox.insert(END, "turquoise")
    listbox.insert(END, "violet")
    listbox.insert(END, "coral")
    listbox.insert(END, "aqua")
